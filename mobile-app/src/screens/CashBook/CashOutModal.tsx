...
const CATEGORIES = ['Purchase', 'Rent', 'Salary', 'Utilities', 'Transport', 'Food', 'Other'];
const RED = '#DC2626';

export const CashOutModal = ({ navigation }: any) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const entry = await createCashEntry(user.id, fullDescription, paisa, 'out', date);
      ...
      await logActivity({
        ...
        entity_type: 'cash',
        entity_id: entry.id,
        description: `Cash Out: ${fullDescription}`,
        amount: paisa / 100
      });
        ...
        <View style={styles.btnRow}>
          ...
          >
            {loading
              ...
              : <Text style={styles.submitText}>- CASH OUT</Text>
            }
          </TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
  ...
  rsPrefix: { fontSize: 18, fontWeight: '700', color: RED, marginRight: 8 },
  amountInput: {
    flex: 1,
    fontSize: 28,
    fontWeight: '800',
