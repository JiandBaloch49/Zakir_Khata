...
export const StockOutReportScreen = ({ navigation }: any) => {
  ...
  const renderItem = ({ item }: { item: StockReportEntry }) => {
    ...
    const rate = item.sale_price_unit || item.cost_per_unit || 0;
    ...
    return (
      <View style={styles.row}>
        ...
        <View style={styles.cellQty}>
          <Text style={[styles.valText, { color: Colors.error }]}>{qty}</Text>
        </View>
        <View style={styles.cellRate}>
          <Text style={styles.valText}>{rate ? formatCurrency(rate) : '-'}</Text>
        </View>
        <View style={styles.cellAmount}>
          <Text style={[styles.valText, { color: Colors.error }]}>{formatCurrency(amount)}</Text>
        </View>
      </View>
    );
  };
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Stock OUT Report</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      <ScreenContainer scrollable={false} hasTabBar={true} style={styles.container}>
        ...
        <View style={styles.tableHeaderRow}>
          ...
          <View style={styles.cellQty}>
            ...
            <Text style={[styles.thSubText, { color: Colors.error }]}>{totalQty}</Text>
          </View>
          <View style={styles.cellRate}>
          ...
          <View style={styles.cellAmount}>
            ...
            <Text style={[styles.thSubText, { color: Colors.error }]}>{formatCurrency(totalAmount)}</Text>
          </View>
        </View>
